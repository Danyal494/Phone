...
// const textColor = headingColor; // Define textColor or use headingColor
...
// context.fillText(someData, canvas.width / 2 , yPosition);
// yPosition += lineHeight
// context.fillText(additionalText, canvas.width / 8, yPosition);
// yPosition += lineHeight;

// context.fillText(additionalText, canvas.width / 7, yPosition);
// yPosition += lineHeight;
...
// const redText = "Text for the redssssss  goes here";
// context.fillStyle = 'black'; // Or any color that contrasts with red
// context.save();
// context.translate(canvas.width / 2, canvas.height / 2); // Move origin to center

// const radius = 200; // Adjust based on your design
// const startAngle = Math.PI * 0.75; // Starting angle of the red area
// const endAngle = Math.PI * 1.25; // Ending angle of the red area
...
//   { height: "83vh", width: "37vw", position: "absolute", zIndex: 10 ,left: "20%",top:"30%",borderRadius:"38px"}
  ...
  return (
    ...
    <div className="">
      {loading ? (<Loader/>):( <Canvas style={responsiveStyles} camera={{ position: [0, 0, 0.1], fov: 10 }}>
