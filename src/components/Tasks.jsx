...
<Canvas camera={{ position: [0, 0, 0.1], fov: 10 }} style={responsiveStyles}>
...
<BlenderSphere text={text} headingColor={headingColor}
buttonColor={buttonColor} createTextTexture={createTextTexture} heading={heading}  textColor={textColor}  position={[0, 0.1, 0]}
rotateX={rotateX} rotateY={rotateY} mobile={mobile} color={color}  decalPositions={[[1, 0, 0], [-1, 0, 0], [0, 1, 0]]} 
  />
